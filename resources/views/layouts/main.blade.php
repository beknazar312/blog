            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav class="hidden md:flex md:grow">
                    ...
                    <ul class="flex grow justify-end flex-wrap items-center">
                        <li>
                            <a class="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out" href="/blog">Блог</a>
                        </li>
                    </ul>
                ...
                <div class="flex md:hidden" x-data="{ expanded: false }">
                    ...
                    >
                        <ul class="px-5 py-2">
                            <li>
                                <a class="flex text-gray-600 hover:text-gray-900 py-2" href="/blog">Блог</a>
                            </li>
                            <li>
                                <a class="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" href="signin.html">Войти</a>
                            </li>
                            <li>
